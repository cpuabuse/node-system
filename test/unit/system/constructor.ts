					...
					throws(
						...
						function(error: any): boolean {
							return (
								...
								error.code === "functionality_error"
							);
						}
					);
					done();
			...
			it("should not generate inappropriately defined errors", function(): void {
				strictEqual(
					Object.prototype.hasOwnProperty.call(
						systemTest.private.error,
						"not_object"
					),
					false
				);
			});
			systemErrors.forEach(function(error: ErrorTest): void {
				it(`should generate the default message with  + ${error.description}`, function(): void {
					strictEqual(
						systemTest.private.error[error.error].message,
